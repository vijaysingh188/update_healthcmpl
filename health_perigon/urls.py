...
from accounts.views import (user_login,login_view_admin_user,home,show_events,event_register_form, password_reset_admin, change_password_admin, send_otp_admin, laboratory_edit,
...
urlpatterns = [
    ...
    path('login_view_admin_user/<int:module_id>/',login_view_admin_user, name="login_view_admin_user"),
